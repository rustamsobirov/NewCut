...
class BookStylistAdapter:RecyclerView.Adapter<BookStylistAdapter.VH>() {
    private val dif = AsyncListDiffer(this, BookStylistAdapter.ITEM_DIFF)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int, ): BookStylistAdapter.VH {
        return VH(
            DetailReviewItemBinding.inflate(
    ...
    override fun onBindViewHolder(holder: BookStylistAdapter.VH, position: Int) =
        holder.bind()
